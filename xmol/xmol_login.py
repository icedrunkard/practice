...
#requests.get('http://www.x-mol.com/login', cookies = get_cookie_from_network())

x=requests.get('http://www.x-mol.com/university/faculty/8510', cookies = get_cookie_from_network())
print x.content
